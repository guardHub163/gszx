...
{
    [Serializable]
    public class BaseOrderInfoTable
    {

        public BaseOrderInfoTable()
        { }
        #region Model
        ...
        private int? _send_flag = 0;
        private decimal? _actual_goods_amount;
        private int? _print_status = 0;
        private string _community;
        private int? _community_code = 0;
        private List<BaseOrdersGoodsTable> _items = new List<BaseOrdersGoodsTable>();

       public List<BaseOrdersGoodsTable> ITEMS
        {
            get { return _items; }
            set { _items = value; }
        }
        ...
        public void AddItem(BaseOrdersGoodsTable model)
        {
            _items.Add(model);
        }
