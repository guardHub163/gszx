...
namespace CZZD.ERP.Common
{
    public class CConstant
    {
        ...
        public static int ShIPPING_TWO =1;//已拣货
        public static int ShIPPING_THREE = 2;//发货中
        public static int ShIPPING_FOUR = 3;//已收货
        ...
        //出货回写状态
        public static int LIBRARY_OUT = 0;//出货

        public static int LIBRARY_INT = 1;//收到货回写

        //发货收货的状态
        public static int SEND_ORDER_STATUS_FA = 1;//发货

        public static int SEND_ORDER_STATUS_SHOU = 2;//收货
