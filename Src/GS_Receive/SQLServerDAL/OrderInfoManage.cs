...
using CZZD.GSZX.R.DBUtility;
using System.Data;
using System.Data.SqlClient;
using CZZD.GSZX.R.Model;

namespace CZZD.GSZX.R.SQLServerDAL
{
    public class OrderInfoManage : IOrderInfo
    {
        ...
        public int Add(BllOrderInfoTable model)
        {
            ...
            parameters[63].Value = model.ACTUAL_GOODS_AMOUNT;
            ...
            foreach (BllOrderGoodsTable lineMode in model.ORDER_GOODS)
            {
                ...
                SqlParameter[] lineParams = {
					...
					new SqlParameter("@ACTUAL_NUMBER", SqlDbType.Decimal,9)};
                ...
                lineParams[16].Value = lineMode.ACTUAL_NUMBER;
