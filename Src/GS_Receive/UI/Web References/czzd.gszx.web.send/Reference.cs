...
namespace CZZD.GSZX.R.UI.czzd.gszx.web.send {
    ...
    public partial class _Send : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public _Send() {
            this.Url = global::CZZD.GSZX.R.UI.Properties.Settings.Default.gszx_r_czzd_gszx_send__Send;
        ...
        /// <remarks/>
        public void GetOrdersAsync(string type, string orderIds, string time, string keys) {
            this.GetOrdersAsync(type, orderIds, time, keys, null);
        }
        
        /// <remarks/>
        public void GetOrdersAsync(string type, string orderIds, string time, string keys, object userState) {
