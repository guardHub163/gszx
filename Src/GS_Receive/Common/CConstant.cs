...
namespace CZZD.GSZX.R.Common
{
    ...
    public class CConstant
    {
        ...
        //订单送信状态的回写
        public static string TYPE_SEND_STATUS = "send_status";
        ...
        public static int ORDER_SHIPPED = 1;
        ...
        public const string TIMER_PRODUCT_CATEGORY = "category";
        public const string TIMER_PRODUCT = "goods";
        public const string TIMER_CUSTOMER = "users";
        public const string TIMER_CUSTOMER_ADDRESS = "user_address";
        #endregion
